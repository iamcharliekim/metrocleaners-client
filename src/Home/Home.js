                ...
                <div className={styles["orders-list-wrapper"]} >
                    <div className={styles["orders-card"]}>
                        <header className={styles["orders-card-header"]}>
                            <div className={styles["order-customer-details"]}>
                                <h4>David Kim</h4>
                                <Link to='orders/94823' className={styles['order-link']}>#94823</Link>
                            </div>
                            <span className={styles["order-not-picked-up-btn"]}>
                                .
                            </span>
                        </header>
                    ...
                    <div className={styles["orders-card"]}>
                        <header className={styles["orders-card-header"]}>
                            <div className={styles["order-customer-details"]}>
                                <h4>Young Choi</h4>
                                <Link to='orders/94824' className={styles['order-link']}>#94826</Link>
                            </div>
                            <span className={styles["order-picked-up-btn"]}>
                                .
                            </span>
                        </header>
                    ...
                    <div className={styles["orders-card"]}>
                        <header className={styles["orders-card-header"]}>
                            <div className={styles["order-customer-details"]}>
                                <h4>John Smith</h4>
                                <Link to='orders/94824' className={styles['order-link']}>#94828</Link>
                            </div>
                            <span className={styles["order-picked-up-btn"]}>
                                .
                            </span>
                    ...
                    <div className={styles["orders-card"]}>
                        <header className={styles["orders-card-header"]}>
                            <div className={styles["order-customer-details"]}>
                                <h4>TJ Stalcup</h4>
                                <Link to='orders/94824' className={styles['order-link']}>#94840</Link>
                            </div>
                            <span className={styles["order-picked-up-btn"]}>
                                .
                            </span>
